...
describe("Xenonstack Website Testing", function () {
    this.timeout(700000);
    let driver;
    ...
    it("Test Case 1: Footer links", async function () {
    ...
    it("Test Case 2: Homepage All Buttons", async function () {
    ...
    it("Test Case 3: Handle Invalid Page Checking", async function () {
        await driver.manage().window().maximize();
        ...
        if (
            ...
            console.log(
                "❌ Invalid page handling test failed."
            );
        }
    });

    it("Test Case 4: Navbar Links Testing", async function () {
        await driver.manage().window().maximize();
        await driver.get("https://www.xenonstack.com/");
    ...
    it("Test Case 5: Homepage Xenonstack Logo Checking", async function () {
        await driver.manage().window().maximize();
        await driver.get("https://www.xenonstack.com/");
    ...
    it("Test Case 6: Perform Compatibility tests for different devices", async function () {
    ...
    it("Test Case 7: Measure page load time", async function () {
        let driver = await new Builder().forBrowser("chrome").build();
    ...
    it("Test Case 8: Measure button click response time", async function () {
        let driver = await new Builder().forBrowser("chrome").build();
    ...
    it("Test Case 9: GetStarted Invalid Inputs", async function () {
        await driver.manage().window().maximize();
        await driver.get("https://www.xenonstack.com/");
        await driver
            .wait(
    ...
    it("Test Case 10: GetStarted Valid Inputs", async function () {
        await driver.manage().window().maximize();
        await driver.get("https://www.xenonstack.com/");
        await driver
            .wait(
