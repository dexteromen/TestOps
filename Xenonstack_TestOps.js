...
describe("Xenonstack Functional and Non-Functional Testing", function () {
    ...
    // it("Test Case 1: should validate invalid inputs", async function () {
    ...
    // it("Test Case 2: should validate valid inputs", async function () {
    //     await driver.manage().window().maximize();
    //     await driver.get("https://www.xenonstack.com/");
    //     await driver
    //         .wait(
    ...
    it("Test Case 3: should test all buttons on the website", async function () {
        this.timeout(300000); // set timeout to 300 seconds
        try {
            await driver.manage().window().maximize();
            await driver.get("https://www.xenonstack.com/");
            await driver.executeScript(
    ...
    // it("Test Case 4: should handle invalid page gracefully", async function () {
    //     await driver.manage().window().maximize();
    ...
    // it("Test Case 5: should test navbar links", async function () {
    //     await driver.manage().window().maximize();
    //     await driver.get("https://www.xenonstack.com/");
    ...
    // it("Test Case 6: should test Xenonstack logo click", async function () {
    //     await driver.manage().window().maximize();
    //     await driver.get("https://www.xenonstack.com/");
    ...
    // it("Test Case 7: should perform compatibility tests for different devices", async function () {
    ...
    // it("Test Case 8: should measure page load time", async function () {
    ...
    // it("Test Case 9: should measure button click response time", async function () {
    //     let driver = await new Builder().forBrowser("chrome").build();
    ...
    it("Test Case 10: should check all footer links and throw an error if any link is not working", async function () {
        let driver = await new Builder().forBrowser('chrome').build();
