...
(async function testXenonstackLogo() {
  ...
  try {
    ...
    if (scrollPosition === 0) {
      console.log('✅ Navbar Logo test passed: The logo click scrolled the page to the top.');
    } else {
      console.log('❌ Navbar Logo test failed: The logo click did not scroll the page to the top.');
    }
  } catch (err) {
